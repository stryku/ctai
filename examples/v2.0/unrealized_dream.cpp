/*
 * In case you want to compile this and you're not a NASA's employee. I tried to compile this shit but it took ~30GB of memory and didn't managed to finish (~8 hours).
 * So if you have a supercomputer in your basement, go ahead. And of course let me know if it's working (:
 */
