...
namespace ctai
{
    ...
    using registers_after_mov = set_reg<typename thread_t::registers,
        ...
        //mov * PTR [ reg ] , value
        template <typename thread_t, typename machine_state_t, size_t value, size_t mem_ptr_reg, size_t mem_size, size_t ...rest_of_opcodes>
        struct ex_instruction<thread_t,
                              machine_state_t,
                              inst::to_size<inst::id_t::MOV_MEM_VAL__mem_eq_reg>,
                              mem_ptr_reg,
                              mem_size,
                              value,
                              rest_of_opcodes...>
        {
            ...
            using final_registers = adjust_eip<typename thread_t::registers, inst::id_t::MOV_MEM_VAL__mem_eq_reg>;
                              ...
                              rest_of_opcodes...>
        {
            ...
            using final_registers = adjust_eip<typename thread_t::registers, inst::id_t::MOV_MEM_VAL__mem_eq_reg_minus_const>;
